...
class NotificationWidget{
  ...
  async => _notifications.zonedSchedule(id, title, body, _scheduledDaily(Time(01,40)), await notificationDetails(), payload:payload,
  ...
  async => _notifications.zonedSchedule(id, title, body, _scheduledWeekly(Time(09,57),days:[DateTime.thursday]), await notificationDetails(), payload:payload,
